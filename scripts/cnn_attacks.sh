...
python cnn_attacks.py --data-path ~/runs/adv/mcyt_classifiers.pickle  \
--defense-model-path ~/runs/signet/model_last.pth --save-path ~/runs/adv/mcyt_cnn_attacks_pk.pickle

python cnn_attacks.py --data-path ~/runs/adv/mcyt_classifiers.pickle  \
--defense-model-path ~/runs/signet/model_last.pth --save-path ~/runs/adv/mcyt_cnn_attacks_lk.pickle --lk


python cnn_attacks.py --data-path ~/runs/adv/cedar_classifiers.pickle  \
--defense-model-path ~/runs/signet/model_last.pth --save-path ~/runs/adv/cedar_cnn_attacks_pk.pickle

python cnn_attacks.py --data-path ~/runs/adv/cedar_classifiers.pickle  \
--defense-model-path ~/runs/signet/model_last.pth --save-path ~/runs/adv/cedar_cnn_attacks_lk.pickle --lk


python cnn_attacks.py --data-path ~/runs/adv/brazilian_classifiers.pickle  \
--defense-model-path ~/runs/signet/model_last.pth --save-path ~/runs/adv/brazilian_cnn_attacks_pk.pickle

python cnn_attacks.py --data-path ~/runs/adv/brazilian_classifiers.pickle  \
--defense-model-path ~/runs/signet/model_last.pth --save-path ~/runs/adv/brazilian_cnn_attacks_lk.pickle --lk


python cnn_attacks.py --data-path ~/runs/adv/gpds_classifiers.pickle  \
--defense-model-path ~/runs/signet/model_last.pth --save-path ~/runs/adv/gpds_cnn_attacks_pk.pickle

python cnn_attacks.py --data-path ~/runs/adv/gpds_classifiers.pickle  \
--defense-model-path ~/runs/signet/model_last.pth --save-path ~/runs/adv/gpds_cnn_attacks_lk.pickle --lk
